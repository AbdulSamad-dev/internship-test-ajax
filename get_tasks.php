    ...
    <div class="accordion-item">
      ...
      <div id="flush-collapse-<?php echo $row['id']; ?>" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample"> 
        <div class="accordion-body"> 
          ...
          <span  class='badge <?php echo $row["priority"]==0?"text-bg-info":"text-bg-danger"; ?>'> 
            <?php echo $row['priority']?"High":"Low"; ?>
          </span>
          <span onclick="updatePriority(<?php echo $row['id'] ?>, <?php echo $row['priority'] ?>)" id="btn-change-priority" class="btn btn-sm btn-outline-dark">Change Priority</span>
